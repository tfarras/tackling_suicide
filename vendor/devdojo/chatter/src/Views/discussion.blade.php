	    ...
	    <div class="row" >
            ...
            @endif
				...
				<div class="conversation" >
	                <ul class="discussions" style="display:block; border-radius: 30px;">
	                	@foreach($posts as $post)
	                		<li data-id="{{ $post->id }}" data-markdown="{{ $post->markdown }}">
		                		<span class="chatter_posts" style=" border-top:none;">
				...
				@else
					...
					<div id="login_or_register">
						<p>Please <a href="/{{ Config::get('chatter.routes.home') }}/login">login</a> or <a href="/{{ Config::get('chatter.routes.home') }}/login">register</a> to leave a response.</p>
					</div>
